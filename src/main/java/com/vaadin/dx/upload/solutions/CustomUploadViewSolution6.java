...
/**
 * Solution for Task 6: Customizing the upload button for mobile
 * (includes Tasks 1-5 solutions)
 */
@Route("solution/6")
@Menu(title = "Solution 6 - Mobile Capture")
public class CustomUploadViewSolution6 extends VerticalLayout {

    private static final Logger logger = LoggerFactory.getLogger(CustomUploadViewSolution6.class);

    public CustomUploadViewSolution6() {
        setSizeFull();
        setPadding(false);
        setSpacing(false);
        ...
        // Task 6: Configure the upload button to use the device's back-facing
        // camera when on mobile
